...
--
-- Table structure for table `tbl_coborrower`
--

CREATE TABLE `tbl_coborrower` (
...
--
-- Indexes for table `tbl_coborrower`
--
ALTER TABLE `tbl_coborrower`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_coborrower`
--
ALTER TABLE `tbl_coborrower`
