                                                        ...
                                                        <div class="col-md-8 col-lg-4">
                                                            <!--<input  class="form-control"type="number" name="lncome_per_month" maxlength="2" placeholder="1-2">-->
                                                               <select  name="lncome_per_month" class="form-control">
                                                                ...
                                                                <option> <% System.out.print(i+""); %> </option>
                                                                <%}
                                                                         %>
<!--                                                                <option>2</option>
                                                                <option>3</option>
                                            ...
                                            <div class="box box-primary box-solid">
                                                ...
                                                <input type="hidden" name="loanstatustype" value="รอตวรจสอบ"/>
                                                <hr class="hrsuccess">
                                                <input type="hidden" name="todo"/>
                                                <div class="col-md-12" align="center">
                                                    <button type="submit" id="submit" name="submit" class="btn btn-primary" disabled="" onclick="oninsert('save')" >บันทึก</button>
                                                    <a name="reset" type="reset" class="btn btn-danger"  data-toggle="modal" data-target="#myModal" >ยกเลิก</a>
                                                </div>
